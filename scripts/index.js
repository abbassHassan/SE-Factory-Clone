...
function changeTab(tabNumber) {
  ...
  let programs_section = document.querySelector(".programs-section");
  ...
  switch (tabNumber) {
    case 1:
      ...
      programs_section.style.backgroundColor = "rgb(255, 198, 53)";
      break;
    case 2:
      ...
      programs_section.style.backgroundColor = "rgb(40, 238, 167)";
      break;
    case 3:
      ...
      programs_section.style.backgroundColor = "rgb(152, 100, 218)";
      break;
    case 4:
      ...
      programs_section.style.backgroundColor = "rgb(251, 80, 142)";
      break;
    default:
      break;
  }
